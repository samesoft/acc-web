...
import { userService } from 'src/app/pages/form/components/user-list/userManagment.service';
@Component({
...
export class TopbarComponent implements OnInit {
  ...
  constructor(@Inject(DOCUMENT) private document: any, private eventService: EventService, public languageService: LanguageService, private modalService: NgbModal,
    ...
    private router: Router, private TokenStorageService: TokenStorageService ,private formBuilder: FormBuilder,private userService:userService) { }
